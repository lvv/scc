...
CAUTION: Currently SCC goes through major changes (to make it x100 faster for AWK ops).
Readme is not updated and  examples  after this point will work only for commit tagged as v0.1 
